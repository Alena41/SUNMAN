...
water_image_path = 'foto/water.jpg'
...
field = [
    ...
    "xoxxxoxxxoxxxoxxxoxxxoxxxoxxxox",
    "xoxxxoxxxoxxxoxxxoxxxoxxxoxxxox",
    "xoxxxoxxxoxxxoxxxoxxxoxxxoxxxox",
    "xooooooooooooooooooooooooooooox",
    "xoxxxxxxxxxxxxxoxxxxxxxxxxxxxox",
    "xoxoooooooooooooooooooooooooxox",
    "xoxoxxoxxoxxxoxxxoxxoxxoxxxoxox",
    "xoxoxxoxxoxxxoxxxoxxoxxoxxxoxox",
    "xoxoooooooooooooooooooooooooxox",
    "xoxoxxxxxxxxxxxxxxxxxxxxxxxoxox",
    "xoxoooooooooooooooooooooooooxox",
    "xoxoxxxoxxxxoxxxoxxxxoxxxxxoxox",
    "xoxoxxxoxxxxoxxxoxxxxoxxxxxoxox",
    "xoxoooooooooooooooooooooooooxox",
    "xoxxxxxxxxxxxxxoxxxxxxxxxxxxxox",
    "xooooooooooooooooooooooooooooox",
...
class Pathfinder(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load('foto/yellow — копия.png')
...
def handle_collision():
    ...
    if (player.rect.colliderect(chaser.rect) or
            player.rect.colliderect(chaser1.rect) or
            player.rect.colliderect(chaser2.rect)):
        player_lives -= 1
        if player_lives <= 0:
            return True
...
def update_coins_counter():
    ...
    coin_counter = font.render(f"Coins: {total_coins}",
                               True, (0, 0, 0))
    with open('coin_file_2.txt', 'w') as file:
...
while running:
    ...
    if not coins and not game_over_flag:
        pygame.quit()
        subprocess.call(['python', 'three_lvl.py'])
        sys.exit()
