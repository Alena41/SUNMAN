...
stone_image_path = 'foto/wood.png'
stone_image = pygame.image.load(stone_image_path)
...
field = [
    ...
    "xooooooooxxoooooooxxooooxxoooox",
    "xoxxxoxxoxxoxxoxxoxxoxxoxxoxxox",
    "xoxxxoxxoxxoxxoxxoxxoxxooooxxox",
    "xoxxxoxxoxxoxxoxxoxxoxxxxxoxxox",
    "xoxxxoxxoxxoxxoxxoxxoxxxxxoxxox",
    "xooooooooooooooooooooooooooxxox",
    "xoxxxoxxxxxxxxoxxxxxoxxoxxxxxox",
    "xoxxxoxxxxxxxxoxxxxxoxxoxxxxxox",
    "xoxxxooooxxooooooooooxxooooxxox",
    "xoxxxoxxoxxoxxxxxoxxoxxoxxoxxox",
    "xoxxxoxxoxxoxxxxxoxxoxxoxxoxxox",
    "xoooooxxooooxxxxxoxxooooxxoooox",
    "xxxxxoxxxxxoxxxxxoxxxxxoxxxxxox",
    "xxxxxoxxxxxoxxxxxoxxxxxoxxxxxox",
    "xoooooxxooooxxxxxoxxooooxxoooox",
    "xoxxxoxxoxxoxxxxxoxxoxxoxxoxxox",
...
class Pathfinder(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load('foto/green — копия — копия.png')
    ...
    def update(self):
        if pygame.time.get_ticks() - self.move_timer > self.move_interval:
            possible_moves = [(1, 0), (-1, 0), (0, 1),
                              (0, -1)]  # Все возможные направления
...
def handle_collision():
    global player_lives
    if (player.rect.colliderect(chaser.rect) or
            player.rect.colliderect(chaser1.rect)):
        player_lives -= 1
        if player_lives <= 0:
            return True
...
def update_coins_counter():
    ...
    coin_counter = font.render(f"Coins: {total_coins}",
                               True, (0, 0, 0))
    with open('coin_file_1.txt', 'w') as file:
...
while running:
    ...
    if not coins and not game_over_flag:
        pygame.quit()
        subprocess.call(['python', 'two_lvl.py'])
        sys.exit()
